...
angular.module("NotSoGrey").service("SharedService",["$http","$q","$window","$state",function(e,o,r,t){var n=this;n.state=t;try{var a=require("electron"),s=a.remote.getCurrentWindow();n.activeColor=s.activeColor||"#c0392b"}catch(e){n.activeColor="#c0392b"}try{chrome&&chrome.storage&&chrome.storage.onChanged.addListener(function(e,o){"local"==o&&null!=e.NSG_COLOR_DATA&&e.NSG_COLOR_DATA!={}&&e.NSG_COLOR_DATA&&"undefined"!=typeof n.activeColorChanged&&"function"==typeof n.activeColorChanged&&n.activeColorChanged(tinycolor(e.NSG_COLOR_DATA.newValue).toHexString())})}catch(e){n.activeColor="#c0392b"}console.log("hello "+n.activeColor),n.actions=[],n.preLoadedThemeInEdit=!1,n.preLoadedTheme=null;try{n.electron=require("electron")}catch(e){n.electron=null}n.colorContrastModes=[{id:1,name:"Normal Vision",key:"normal",anomalize:!1},{id:2,name:"Protanopia",key:"protan",anomalize:!1},{id:3,name:"Protanomaly",key:"protan",anomalize:!0},{id:4,name:"Deuteranopia",key:"deutan",anomalize:!1},{id:5,name:"Deuteranomaly",key:"deutan",anomalize:!0},{id:6,name:"Tritanopia",key:"tritan",anomalize:!1},{id:7,name:"Tritanomaly",key:"tritan",anomalize:!0},{id:8,name:"Achromatopsia",key:"achroma",anomalize:!1},{id:9,name:"Achromatomaly",key:"achroma",anomalize:!0}],n.baseColorWheel=[{id:1,h:28,s:1,v:1,b:15,t:36,o:7,so:6},{id:2,h:0,s:1,v:.99,b:337,t:14,o:8,so:5},{id:3,h:312,s:.99,v:.75,b:301,t:336,o:9,so:4},{id:4,h:287,s:1,v:.75,b:280,t:300,o:10,so:3},{id:5,h:272,s:1,v:.75,b:258,t:279,o:11,so:2},{id:6,h:241,s:1,v:1,b:208,t:257,o:0,so:1},{id:7,h:172,s:1,v:.75,b:147,t:207,o:1,so:12},{id:8,h:119,s:.99,v:.75,b:95,t:146,o:2,so:11},{id:9,h:71,s:1,v:1,b:67,t:94,o:3,so:10},{id:10,h:61,s:1,v:1,b:58,t:66,o:4,so:9},{id:11,h:52,s:1,v:1,b:49,t:57,o:5,so:8},{id:12,h:44,s:1,v:1,b:37,t:48,o:6,so:7}],n.correctForBlindness=function(e,o){var r=tinycolor(e),t=r.toRgb(),n={R:t.r,G:t.g,B:t.b},a=Color.Blind(n,o.key,o.anomalize);return t={r:a.R,g:a.G,b:a.B},tinycolor(t).toHexString()},n.themeGeneratorOptions=[{id:1,name:"Preloaded Themes"},{id:2,name:"Monochromatic"},{id:3,name:"Analogous"},{id:4,name:"Custom Complementary"}],n.getBaseWheelColor=function(e){var o=tinycolor(e),r=o.toHsv(),t=null;return t=r.h>=337&&r.h<=360||r.h>=0&&r.h<=14?n.baseColorWheel[1]:_.find(n.baseColorWheel,function(e){return r.h>=e.b&&r.h<=e.t})},n.getOppositeBaseWheelColor=function(e,o){var r=_.find(n.baseColorWheel,function(o){return o.id==e.id});return r?_.find(n.baseColorWheel,function(e){return 1!=o?e.id==r.o:e.id==r.so}):null},n.getAnalogousColors=function(e){var o=_.find(n.baseColorWheel,function(o){return o.id==e.id}),r=o.id,t=[];t=1==r?[[11,12,1],[12,1,2],[1,2,3]]:2==r?[[12,1,2],[1,2,3],[2,3,4]]:11==r?[[9,10,11],[10,11,12],[11,12,1]]:12==r?[[10,11,12],[11,12,1],[12,1,2]]:[[r-2,r-1,r],[r-1,r,r+1],[r,r+1,r+2]];var a=_.sample(t),s=[];return _.each(a,function(e){var o=_.find(n.baseColorWheel,function(o){return o.id==e});o&&s.push(o)}),s},n.adjustHueValue=function(e,o,r){var t,n=0,a=r.h,s=!1;return 2!=o.id?(t=o.h-e.h,t>0?(n=Math.abs(t)/(o.h-o.b),s=!1):t<0&&(n=Math.abs(t)/(o.t-o.h),s=!0)):e.h>=337&&e.h<=360?(t=360-e.h,n=Math.abs(t)/(360-o.b),s=!1):e.h>=0&&e.h<=14&&(t=0-e.h,n=Math.abs(t)/(o.h-0),s=!0),2!=r.id?1==s?(_deflection=n*(r.t-r.h),a=r.h-_deflection):(_deflection=n*(r.h-r.b),a=r.h+_deflection):a=r.h,a},n.loadActions=function(e,o){n.actions=[],angular.forEach(e,function(e){n.actions.push(angular.copy(e))})},n.writeToClipboard=function(e){var o=require("electron");o.clipboard.writeText(e.toString())},n.getCodeOnlyFromHexCode=function(e){return tinycolor(e).toHex()},n.getHexFromCode=function(e){return tinycolor(e).toHexString()},n.getRGBCodeOnlyFromHexCode=function(e){return tinycolor(e).toRgb()},n.getHSVCodeOnlyFromHexCode=function(e){return tinycolor(e).toHsv()},n.getContrastRatio=function(e,o){var r=tinycolor.readability(tinycolor(e),tinycolor(o));return Math.round(100*r)/100},n.isLight=function(e){return tinycolor(e).isLight()},n.getForegrundContrastedColor=function(e){var o=tinycolor(e),r=tinycolor.readability(o,tinycolor("#000000")),t=tinycolor.readability(o,tinycolor("#ffffff"));return r>t?"#000000":r<t?"#ffffff":r==t?_.sample(["#000000","#ffffff"]):""},n.getCMYK=function(e){var o=tinycolor(e).toRgb(),r=o.r,t=o.g,n=o.b,a=0,s=0,c=0,l=0;if(r=parseInt((""+r).replace(/\s/g,""),10),t=parseInt((""+t).replace(/\s/g,""),10),n=parseInt((""+n).replace(/\s/g,""),10),null==r||null==t||null==n||isNaN(r)||isNaN(t)||isNaN(n))return void alert("Please enter numeric RGB values!");if(r<0||t<0||n<0||r>255||t>255||n>255)return void alert("RGB values must be in the range 0 to 255.");if(0==r&&0==t&&0==n)return l=1,[0,0,0,1];a=1-r/255,s=1-t/255,c=1-n/255;var i=Math.min(a,Math.min(s,c));return a=(a-i)/(1-i),s=(s-i)/(1-i),c=(c-i)/(1-i),l=i,{c:a,m:s,y:c,k:l}},n.getPercentageCMYK=function(e){var o=n.getCMYK(e);return{c:Math.round(100*o.c),m:Math.round(100*o.m),y:Math.round(100*o.y),k:Math.round(100*o.k)}},n.getPercentageRGB=function(e){var o=tinycolor(e),r=o.toRgb();return{r:Math.round(r.r/255*100),g:Math.round(r.g/255*100),b:Math.round(r.b/255*100)}},n.getPercentageHSB=function(e){var o=tinycolor(e),r=o.toHsv();return{h:Math.round(r.h),s:Math.round(100*r.s),b:Math.round(100*r.v)}},n.getNextHueHex=function(e){var o=tinycolor(e).toHsv();return o.h=o.h+18,o.h>360&&(o.h=o.h-360),tinycolor(o).toHexString()},n.getPreviousHueHex=function(e){var o=tinycolor(e).toHsv();return o.h=o.h-18,o.h<0&&(o.h=360+o.h),tinycolor(o).toHexString()},n.processForShades=function(e){var o=[],r=[],t=[];_.each(_.range(6),function(o){t.push({id:"_sat_"+o,hexCode:tinycolor(e).brighten(10*(o+1)).toHexString(),type:"sat"+o})}),_.each(_.range(6),function(o){r.push({id:"_desat_"+o,hexCode:tinycolor(e).darken(5*(o+1)).toHexString(),type:"desat"+o})}),r=r.reverse(),o=o.concat(r),o=o.concat([{id:"_nor_",hexCode:e}]),o=o.concat(t),o=o.reverse();var a=0,s=[0,30,35,40,45,50,55,25,30,35,40,45,50],c=0;return _.each(o,function(e,o){o<=6?(c++,e.topOffset=a+s[o],e.zindex=c):o>6&&(c--,e.topOffset=a+80-s[o],e.zindex=c),6==o&&(e.primary=!0),e.foreColor=n.getForegrundContrastedColor(e.hexCode),a=e.topOffset}),{shades:o,height:_.last(o).topOffset+80}};var c;return n.handleChangeInColor=function(e,r,t){c&&c.reject(),c=o.defer();try{var a;"cmyk"==e?a=n.handleCMYKChange(r):"rgb"==e?a=n.handleRGBChange(r):"hsb"==e&&(a=n.handleHSBChange(r)),c.resolve(a)}catch(e){c.resolve(t)}return c.promise},n.handleCMYKChange=function(e){var o={r:Math.round(255*(1-e.c/100)*(1-e.k/100)),g:Math.round(255*(1-e.m/100)*(1-e.k/100)),b:Math.round(255*(1-e.y/100)*(1-e.k/100))};return tinycolor(o).toHexString()},n.handleRGBChange=function(e){var o={r:Math.round(255*(e.r/100)),g:Math.round(255*(e.g/100)),b:Math.round(255*(e.b/100))};return tinycolor(o).toHexString()},n.handleHSBChange=function(e){var o={h:e.h,s:e.s,v:e.b};return tinycolor(o).toHexString()},n.handleChangeInCMYK=function(e,o){return n.handleChangeInColor("cmyk",e,o)},n.handleChangeInRGB=function(e,o){return n.handleChangeInColor("rgb",e,o)},n.handleChangeInHSB=function(e,o){return n.handleChangeInColor("hsb",e,o)},n.generateThemes=function(){var e=o.defer();return n.resource("dist/js/jsons/themes-popular.json").query().$promise.then(function(o){var r=tinycolor(n.activeColor).toHsv(),t=[];_.each(o,function(e,o){var n=[],a=!1;_.each(e,function(e){var o=tinycolor(e),t=o.toHsv();t.h>=r.h-3&&t.h<=r.h+3&&t.s>=r.s-5&&t.s<=r.s+5&&t.v>=r.v-5&&t.v<=r.v+5&&(a=a||!0),n.push(o.toHexString())}),a&&t.push({id:o+1,name:"Beach Time "+(o+1),colors:n})}),n.preGeneratedThemes=t,e.resolve(t)}),e.promise},n.processComboForTheme=function(e){var o=[];return _.each(e.colors,function(e,r){o.push({id:r+1,color:e,locked:!1})}),o},n.generateColorPalette=function(e,o){return 1==o.id?n.generateColorPaletteFromPreLoadedThemes():2==o.id?n.generateColorPaletteMonochromeUsingPlease(e):3==o.id?n.generateColorPaletteAnalagous(e):4==o.id?n.generateColorPaletteCustomComplementary(e):void 0},n.generateColorPaletteFromPreLoadedThemes=function(){var e=_.sample(n.preGeneratedThemes);return n.processComboForTheme(e)},n.generateMonochromeColorPaletteForColor=function(e){var o=[];_.each(_.range(5),function(r){o.push({id:r+1,color:e,locked:!1})}),o[0].locked=!0;var r=tinycolor(o[0].color),t=r.toHsv(),a=Please.make_scheme(t,{scheme_type:"monochromatic",format:"hex"});return _.each(o,function(e,o){e.color=1==e.locked?e.color:a[o],e.foreColor=n.getForegrundContrastedColor(e.color)}),o},n.generateColorPaletteMonochromeUsingPlease=function(e){var o=tinycolor(e[0].color),r=o.toHsv();0==e[0].locked&&(e[0].color=tinycolor({h:_.random(0,360),s:r.s,v:r.v}).toHexString()),o=tinycolor(e[0].color),r=o.toHsv(),r=o.toHsv(),r.s=Math.round(100*r.s),r.v=Math.round(100*r.v);var t=_.random(.5*r.s,100),a=_.random(.5*r.v,100);r.s=t/100,r.v=a/100;var s=Please.make_scheme(r,{scheme_type:"monochromatic",format:"hex"});return _.each(e,function(e,o){e.color=1==e.locked?e.color:s[o],e.foreColor=n.getForegrundContrastedColor(e.color)}),e},n.generateColorPaletteCustomComplementary=function(e){var o=tinycolor(e[0].color),r=o.toHsv();0==e[0].locked&&(e[0].color=tinycolor({h:_.random(0,360),s:r.s,v:r.v}).toHexString()),o=tinycolor(e[0].color),r=o.toHsv();var t=n.getBaseWheelColor(o),a=n.getOppositeBaseWheelColor(t,_.sample([!0,!1])),s=n.adjustHueValue(r,t,a),c=_.random(100*t.s,100),l=_.random(100*t.v,100);s>360&&(s-=360),0==e[4].locked&&(e[4].color=tinycolor({h:s,s:c/100,v:l/100}).toHexString());var i=_.random(0,100*r.v);0==e[1].locked&&(e[1].color=tinycolor({h:r.h,s:r.s,v:i/100}).toHexString()),0==e[3].locked&&(e[3].color=tinycolor({h:s,s:c/100,v:i/100}).toHexString());var u=_.random(0,20),l=_.random(75,100);return 0==e[2].locked&&(e[2].color=tinycolor({h:r.h,s:u/100,v:l/100}).toHexString()),_.each(e,function(e,o){e.foreColor=n.getForegrundContrastedColor(e.color)}),e},n.generateColorPaletteAnalagous=function(e){var o=tinycolor(e[0].color),r=o.toHsv();0==e[0].locked&&(e[0].color=tinycolor({h:_.random(0,360),s:r.s,v:r.v}).toHexString(),e[0].foreColor=n.getForegrundContrastedColor()),o=tinycolor(e[0].color),r=o.toHsv(),r.s=Math.round(100*r.s),r.v=Math.round(100*r.v);var t=_.random(.5*r.s,100),a=_.random(.5*r.v,100);r.s=t/100,r.v=a/100;var s=Please.make_scheme(r,{scheme_type:"analogous",format:"hex"});return _.each(e,function(e,o){e.color=1==e.locked?e.color:s[o],e.foreColor=n.getForegrundContrastedColor(e.color)}),e},n.getDribbleShots=function(e){c&&c.reject(),c=o.defer();try{null!=n.electron?(n.electron.ipcRenderer.send("get-dribbble",tinycolor(e).toHex()),n.electron.ipcRenderer.on("get-dribbble-reply",function(e,o){c.resolve(o)})):c.resolve(["https://d13yacurqjgara.cloudfront.net/users/275149/screenshots/2831723/maplooper_1x.png","https://d13yacurqjgara.cloudfront.net/users/698732/screenshots/2831032/004_1x.png","https://d13yacurqjgara.cloudfront.net/users/124800/screenshots/2830714/workspace_1x.jpg","https://d13yacurqjgara.cloudfront.net/users/14224/screenshots/2830043/03_1x.png","https://d13yacurqjgara.cloudfront.net/users/159078/screenshots/2829616/landing-joined_1x.png","https://d13yacurqjgara.cloudfront.net/users/159078/screenshots/2829606/signup-joined_1x.png","https://d13yacurqjgara.cloudfront.net/users/159078/screenshots/2829591/checkout-joined_1x.png","https://d13yacurqjgara.cloudfront.net/users/361038/screenshots/2829283/400.jpg","https://d13yacurqjgara.cloudfront.net/users/790168/screenshots/2829055/dk_currency_1x.jpg","https://d13yacurqjgara.cloudfront.net/users/261966/screenshots/2828771/untitled-1.png","https://d13yacurqjgara.cloudfront.net/users/970944/screenshots/2827706/dribbble_0-60_1x.gif","https://d13yacurqjgara.cloudfront.net/users/17255/screenshots/2826939/kaleidoscope_1x.png"])}catch(e){console.log(e),c.resolve(["https://d13yacurqjgara.cloudfront.net/users/275149/screenshots/2831723/maplooper_1x.png","https://d13yacurqjgara.cloudfront.net/users/698732/screenshots/2831032/004_1x.png","https://d13yacurqjgara.cloudfront.net/users/124800/screenshots/2830714/workspace_1x.jpg","https://d13yacurqjgara.cloudfront.net/users/14224/screenshots/2830043/03_1x.png","https://d13yacurqjgara.cloudfront.net/users/159078/screenshots/2829616/landing-joined_1x.png","https://d13yacurqjgara.cloudfront.net/users/159078/screenshots/2829606/signup-joined_1x.png","https://d13yacurqjgara.cloudfront.net/users/159078/screenshots/2829591/checkout-joined_1x.png","https://d13yacurqjgara.cloudfront.net/users/361038/screenshots/2829283/400.jpg","https://d13yacurqjgara.cloudfront.net/users/790168/screenshots/2829055/dk_currency_1x.jpg","https://d13yacurqjgara.cloudfront.net/users/261966/screenshots/2828771/untitled-1.png","https://d13yacurqjgara.cloudfront.net/users/970944/screenshots/2827706/dribbble_0-60_1x.gif","https://d13yacurqjgara.cloudfront.net/users/17255/screenshots/2826939/kaleidoscope_1x.png"])}return c.promise},n.getColorName=function(e){c&&c.reject(),c=o.defer();try{null!=n.electron?(n.electron.ipcRenderer.send("get-hexcodename",tinycolor(e).toHexString()),n.electron.ipcRenderer.on("get-hexcodename-reply",function(o,r){c.resolve(r||e)})):c.resolve(e)}catch(o){console.log(o),c.resolve(e)}return c.promise},n}]);
angular.module("NotSoGrey").controller("AppController",["$scope","$timeout","$q","SharedService","$state",function(o,e,t,r,i){var n=this;n.shared=r,n.showCurrentColor=!1,n.direction="fwd",n.name="Not So Grey",n.hideLoader=!1,n.state=i,e(function(){n.hideLoader=!0},1e3),n.actionLaunch=function(o){console.log(o)},n.shared.activeColorChanged=function(e){n.shared.activeColor=e,console.log(n.shared.activeColor),(n.state.current.name="ColorPicker")&&n.shared.initPicker(n.shared.activeColor),o.$$phase||o.$apply()},n.goColorContrast=function(o){n.showCurrentColor=!0,n.direction=o||"fwd",n.state.go("ColorContrast")},n.goColorPicker=function(o){n.showCurrentColor=!1,n.direction=o||"fwd",n.state.go("ColorPicker")},n.goColorDetails=function(o){n.showCurrentColor=!1,n.editColor=!1,n.direction=o||"fwd",n.state.go("ColorDetails.View");var e=[{id:1,name:"color-picker",icon:"icon-png back",fn:"app.closeApp()",title:"Back To Launcher"},{id:2,name:"color-picker",icon:"icon-app-logo",fn:"app.goColorDetails()",active:!0,title:"Color Details"},{id:4,name:"color-contrast",icon:"icon-app-contrast",fn:"app.goColorContrast()",title:"Color Contrast"},{id:3,name:"color-theme",icon:"icon-app-theme",fn:"app.goThemesPopular()",title:"Popular Themes"},{id:5,name:"color-dribbble",icon:"icon-app-dribbble",fn:"app.goDribbble()",title:"Dribbble Shots"}];n.shared.loadActions(e,"ColorDetails.View")},n.ratifyColorDetails=function(){n.editColor=!1,n.goColorDetails(),n.shared.ratifyDetails()},n.goColorEdit=function(o){n.showCurrentColor=!1,n.editColor=!0,n.direction=o||"fwd",n.state.go("ColorDetails.Edit");var e=[{id:3,name:"accept",icon:"icon-png accept",fn:"app.ratifyColorDetails()",title:"Accept Changes",active:!0},{id:1,name:"close",icon:"icon-png reject",fn:"app.revertDetails()",title:"Revert Changes",active:!0}];n.shared.loadActions(e,"ColorDetails.Edit")},n.revertDetails=function(){n.shared.revertToOrig(),n.goColorDetails()},n.goThemesPopular=function(){n.showCurrentColor=!0,n.state.go("ThemesPopular")},n.goThemesCreator=function(){n.showCurrentColor=!0,n.state.go("ThemesCreator")},n.closeApp=function(){console.log(chrome.extension);try{var o=require("electron");o.ipcRenderer.send("close-main")}catch(o){}},n.generateThemes=function(){n.shared.generateThemes()},n.createThemeShuffle=function(){n.shared.shufflePalette()},n.goDribbble=function(){return 0==navigator.onLine?void n.shared.notifySave({msg:"Failed to detect network connectivity!",dontBreak:!0}):(n.showCurrentColor=!0,void n.state.go("DribbbleShots"))}}]);
